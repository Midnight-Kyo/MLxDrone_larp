...
2. **`tello_view.py`** — safe preview, no motors. Requests **720p / 30 fps / 5 Mbps** from the drone and uses **Tello-tuned TrustedHand** (softer MediaPipe thresholds, stronger crop upscale).
